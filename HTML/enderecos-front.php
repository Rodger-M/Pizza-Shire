...
<html lang="pt-BR">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #000;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="float-right login-box">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="Pizzaria/carrinho-teste.php"><i class="fas fa-shopping-cart fa-lg"></i></a>
                        </li>
                        <li class="nav-item dropdown">
        ...
        <?php include 'Pizzaria/enderecos.php';?>
        
        <!-- Tem que arrumar o style no css -->
        <div style="padding: 100px">
        	<a href="cadastraendereco-front.php">Cadastrar endereço</a>
        </div>
