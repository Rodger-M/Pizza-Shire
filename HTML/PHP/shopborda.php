...
/* Cria a query ativos*/
$query = "SELECT cod_produto, descricao, ingredientes, categoria, preco, disponibilidade, imagem FROM produto WHERE categoria = 'Borda' AND disponibilidade = 'Disponivel'";


$result = mysqli_query($link, $query);

    echo '<div id="pizzas">
            <h2>Borda para ' .$base. '</h2>
...
?>
         ...
         <div class="box-produto">
              <form method="post" action="Pizzaria/adicionarborda.php">
             <img class="img-produto" src="Pizzaria/uploads/<?php echo $result[$key]["imagem"]; ?>" alt="Produto">
                <div>
                    ...
                    <input type="hidden" name="complemento" value="Borda de <?php echo $base; ?>">
